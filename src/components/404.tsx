                ...
                <div className="notFound" style={ styles }>
                    ...
                    <div className="main" style={ mainStyle }>
                        <div className="ant-result">
                            <div className="ant-result-icon ant-result-image">
                                <svg width="252" height="294">
                                    ...
                                    <g fill="none" fillRule="evenodd">
                                        ...
                                        <path d="M76.085 221.626c1.153.094 4.038-2.019 6.955-4.935M106.36 225.142s2.774-1.11 6.103-3.883" stroke="#648BD8" strokeWidth="1.051" strokeLinecap="round" strokeLinejoin="round"></path><path d="M107.275 222.1s2.773-1.11 6.102-3.884" stroke="#648BD8" strokeLinecap="round" strokeLinejoin="round"></path>
                                        ...
                                        <path d="M150.29 151.232h-19.863v-33.707h20.784v32.786a.92.92 0 0 1-.92.92" fill="#F4D19D"></path><path d="M123.554 127.896H92.917a.518.518 0 0 1-.425-.816l6.38-9.113c.193-.277.51-.442.85-.442h31.092l-7.26 10.371z" fill="#F2D7AD"></path>
                            ...
                            <div className="ant-result-subtitle">对不起，您访问的页面不存在。</div>
